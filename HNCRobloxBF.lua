...
shared.LoaderTitle = "Follow Kênh Tik Tok HNC Roblox";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://103232376805871",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=103232376805871";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Description = "Follow tui đi mò",
    Callback = function()
        setclipboard("Iu mấy fan nhìu");
    end
});
...
local v51 = v16.Main:AddToggle("ToggleCastleRaid", {
    Title = "Đánh Tập Kích Hải Tặc Biển",
    Description = "",
    Default = false
});
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Tự Động Haki Màu Pháo Đài Nếu Bạn Có",
    Description = "",
    Default = false
});
...
local v55 = v16.Main:AddToggle("ToggleCollectChest", {
    Title = "Cái Này Là Tự Động Nhặt Rương Nha",
    Description = "",
    Default = false
});
...
local v59 = v16.Main:AddSlider("SliderHealt", {
    Title = "Quái Còn Bao Nhiêu Máu Thì Chuyển Sang Cày Thông Thạo?",
    Description = "",
    Default = 20,
    Min = 0,
    Max = 100,
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Bạn Có: " .. tostring(v768) .. " Chiếc Xương");
            end
        end);
    end);
...
if Sea3 then
    ...
    local v491 = v16.Main:AddParagraph({
        Title = "Trạng Thái: Cần Đánh Bao Nhiêu Con Quái Nữa Thì Ra Tư Lệnh",
        Content = ""
    });
    spawn(function()
        while wait() do
    ...
    local v494 = v16.Main:AddToggle("ToggleDoughKing", {
        Title = "Tự Động Đánh Hoàng Tử Bột",
        Description = "",
        Default = false
    });
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        Title = "Triệu Hồi Con Tư Lệnh Bánh",
        Description = "",
        Default = true
    });
...
v16.Sea:AddButton({
    Title = "Đổi Linh Hồn Cho Vật Phẩm Vip",
    Description = "",
    Callback = function()
...
if Sea3 then
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        Title = "Lái Thuyền Về Doanh Trại Tiki",
        Description = "",
        Default = false
    });
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        Title = "Lái Thuyền Về Đảo Phụ Nữ",
        Description = "",
        Default = false
    });
...
if Sea3 then
    ...
    v16.Sea:AddButton({
        Title = "Bay Đến Chỗ Cao Để Nhìn Trăng",
        Description = "",
        Callback = function()
            TweenToHighestPoint();
        end
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://103232376805871") then
                    return v729;
                end
            end
        end
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Bay Đến Ông Bán Trái Cao Cấp",
    Description = "",
    Default = false
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Đánh Quái Trong Raid+Bay Đến Đảo Tiếp Theo",
    Description = "",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Đến Chỗ Trial Của Tộc Draco",
    Description = "",
    Default = false
});
